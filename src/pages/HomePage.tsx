...
const HomePage: React.FC = () => {
  ...
  const { items: questions, isLoading, error, pagination} = useSelector((state: RootState) => state.questions);
  ...
  useEffect(() => {
    dispatch(fetchQuestions({ page: 1, limit: 20 }));
  }, [dispatch]);
  ...
  const filteredAndSortedQuestions = useMemo(() => {
    ...
    // Sort questions based on sortBy option
    switch (sortBy) {
      case 'Most Upvoted':
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => dispatch(fetchQuestions({ page: 1, limit: 20 }))}
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-lg border border-gray-200">
            <div className="text-lg text-gray-600 mb-4">No questions yet</div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {filteredAndSortedQuestions.length === 0 && questions.length > 0 && (
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
            <div className="text-gray-500 mb-4">No questions found matching your filters.</div>
            <button
              onClick={handleClearFilters}
              className="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700"
            >
